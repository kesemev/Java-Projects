 ...
 */
public class DecorateBorderDialog extends JDialog implements ActionListener {
	    ...
	    public DecorateBorderDialog(CityPanel pan, String title)
	    {	
	    ...
	    public void actionPerformed(ActionEvent e)
	    {
	 		if(e.getSource() == ok)
			{
	            ...
	            if (!selectedVehicle.equals("No vehicle") ) {
	            	Vehicle choosen = vehicles.get(Integer.parseInt("" + selectedVehicle.charAt(0)));
	            	choosen.changeBorder();
	                setVisible(false);
	            }
	            else
